...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GalleryOptions.site'
        db.alter_column(u'gallery_galleryoptions', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True))
        # Adding unique constraint on 'GalleryOptions', fields ['site']
        db.create_unique(u'gallery_galleryoptions', ['site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GalleryOptions', fields ['site']
        db.delete_unique(u'gallery_galleryoptions', ['site_id'])


        # Changing field 'GalleryOptions.site'
        db.alter_column(u'gallery_galleryoptions', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']))
