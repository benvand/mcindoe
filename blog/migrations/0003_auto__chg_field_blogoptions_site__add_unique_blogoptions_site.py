...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogOptions.site'
        db.alter_column(u'blog_blogoptions', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True))
        # Adding unique constraint on 'BlogOptions', fields ['site']
        db.create_unique(u'blog_blogoptions', ['site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlogOptions', fields ['site']
        db.delete_unique(u'blog_blogoptions', ['site_id'])


        # Changing field 'BlogOptions.site'
        db.alter_column(u'blog_blogoptions', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']))
